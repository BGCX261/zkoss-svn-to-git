package org.zerokode.designer.config;
...
/**
 * Class that provides initialization
 * and configuration data.
 * @author chris.spiliotopoulos
 *
 */
public class Configurator implements IDisposable
{
	/**
	 * The iDOM document 
	 */
	...
	public void dispose()
	{
		...
		if (! ArrayUtils.isEmpty(_arrElements))
		{
			for (int i = 0; i< _arrElements.length; i++)
				_arrElements[i] = null;
		}
